...
export const Route = createFileRoute("/services/education-&-skills-development")({
  head: () => ({
    meta: [
      { title: "Education & Skills Development — Free Medical Camps | WOPF" },
      {
        name: "description",
        content:
          "WOPF's Education & Skills Development program runs free medical camps, screening days and medicine counters across interior Sindh. Sponsor a camp or volunteer.",
      },
      { property: "og:title", content: "Education & Skills Development — WOPF" },
      {
...
const HEALTH_FAQS = [
  ...
  return (
    <SiteLayout>
      ...
      <HealthBanner
        eyebrow="Education & Skills Development"

...
export const Route = createFileRoute("/services/humanitarian-support-&-poverty-alleviation")({
  head: () => ({
    meta: [
      { title: "Humanitarian Support & Poverty Alleviation — Free Medical Camps | WOPF" },
      {
        name: "description",
        content:
          "WOPF's Humanitarian Support & Poverty Alleviation program runs free medical camps, screening days and medicine counters across interior Sindh. Sponsor a camp or volunteer.",
      },
      { property: "og:title", content: "Humanitarian Support & Poverty Alleviation — WOPF" },
      {
...
const HEALTH_FAQS = [
  ...
  return (
    <SiteLayout>
      ...
      <HealthBanner
        eyebrow="Humanitarian Support & Poverty Alleviation"

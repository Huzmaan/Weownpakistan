...
export const Route = createFileRoute("/services/disaster-&-emergency-relief")({
  head: () => ({
    meta: [
      { title: "Disaster & Emergency Relief — Free Medical Camps | WOPF" },
      {
        name: "description",
        content:
          "WOPF's Disaster & Emergency Relief program runs free medical camps, screening days and medicine counters across interior Sindh. Sponsor a camp or volunteer.",
      },
      { property: "og:title", content: "Disaster & Emergency Relief — WOPF" },
      {
...
const HEALTH_FAQS = [
  ...
  return (
    <SiteLayout>
      ...
      <HealthBanner
        eyebrow="Disaster & Emergency Relief"

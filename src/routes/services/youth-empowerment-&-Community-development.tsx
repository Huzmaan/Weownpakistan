...
export const Route = createFileRoute("/services/youth-empowerment-&-Community-development")({
  head: () => ({
    meta: [
      { title: "Youth Empowerment & Community Development — Free Medical Camps | WOPF" },
      {
        name: "description",
        content:
          "WOPF's Youth Empowerment & Community Development program runs free medical camps, screening days and medicine counters across interior Sindh. Sponsor a camp or volunteer.",
      },
      { property: "og:title", content: "Youth Empowerment & Community Development — WOPF" },
      {
...
const HEALTH_FAQS = [
  ...
  return (
    <SiteLayout>
      ...
      <HealthBanner
        eyebrow="Youth Empowerment & Community Development"
